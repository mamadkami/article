...
const portfolioItems = [
  ...
  },
  {
    ...
    title: "جنگل مه‌آلود",
    category: "عکاسی طبیعت",
    image: "https://images.pexels.com/photos/4827/nature-forest-trees-fog.jpeg?auto=compress&cs=tinysrgb&w=800",
    likes: 415,
    views: 2200,
  ...
  },
  {
    ...
    title: "ساحل آرام",
    category: "عکاسی طبیعت",
    image: "https://images.pexels.com/photos/533923/pexels-photo-533923.jpeg?auto=compress&cs=tinysrgb&w=800",
    likes: 450,
    views: 2400,
  ...
  },
  {
    ...
    category: "برندینگ",
    image: "https://images.pexels.com/photos/288477/pexels-photo-288477.jpeg?auto=compress&cs=tinysrgb&w=800",
    likes: 268,
    views: 1290,
...
exports.seed = async function (knex) {
  ...
  await knex('categories').insert(categories.map((name, index) => ({ id: index + 1, name })));
  await knex('portfolio_items').insert(portfolioItems.map(item => ({
    id: item.id,
    title: item.title,
  ...
  await knex('services').insert(services.map((service, index) => ({
    id: index + 1,
    title: service.title,
    description: service.description,
    features: JSON.stringify(service.features),
  })));
  await knex('stats').insert(stats.map((stat, index) => ({
    id: index + 1,
    number: stat.number,
    label: stat.label,
  })));
